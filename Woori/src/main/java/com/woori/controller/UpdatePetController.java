...
public class UpdatePetController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println(dogName+" "+dogGender+" "+dogWeight+" "+dogBirthday+" "+dogAdoptionDate+" "+img1+" "+img2+" "+img3+" "+email+idx);
        ...
        System.out.println("업데이트 펫 : "+allergy+" "+disease+" "+food+" "+etc);
        ...
        System.out.println("업데이트 케어 :"+allergy+disease+food+etc+idx);
        PetDAO Pdao = new PetDAO();
        CareDAO Cdao = new CareDAO();
        
        int row = Pdao.updatePet(p);
        int cnt = Cdao.updateCare(care);
